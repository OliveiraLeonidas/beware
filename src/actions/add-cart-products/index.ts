...
import { addProductToCartSchema, addProductToCartSchemaType } from "./schema"

export const addProductToCart = async (data: addProductToCartSchemaType) => {
  ...
  const cartItem = await db.query.cartItemTable.findFirst({
    where: (
    cartItem, { eq }) => eq(cartItem.cartId, cartId) && 
