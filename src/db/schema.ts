...
// relations between product and product variants
...
// relations between tables category -> products -> product_variants
...
export const shippingAddressTable = pgTable("shipping_address", {
  ...
  phone: text().notNull(),
  email: text("cpf_or_cnpj").notNull(),
...
// TODO: ADD TOTAL PRICE IN CARTTABLE TO CREATE BETTER QUERIES
